...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'internalEmployees', path: '/employees/internal', permissionsAny: ['employee_internal:read'], group: 'people', icon: 'employees' },
  { label: 'externalEmployees', path: '/employees/external', permissionsAny: ['employee_external:read'], group: 'people', icon: 'employees' },
  { label: 'payslips', path: '/payslips', permission: 'payslip:read', group: 'people', icon: 'payslip', exact: true },
  ...
  { label: 'myWarnings', path: '/me/warnings', permission: 'my_space:read', group: 'mySpace', icon: 'warnings', exact: true },
